...
CHROMA_DATA_PATH = "os.path.expanduser("~/.chromaflow/data/TestDB")"
...
# OR, keep the above commented out
# and use the below to beautify the output in the console and make it easily readable
